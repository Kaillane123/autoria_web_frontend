...
import responsavelController from "../js/controller/ResponsavelController.js";
import IntercambistaController from "./controller/IntercambistaController.js";
...
$("#lista_intercambista").addEventListener("click", function() {
  fecharNavBar();
  IntercambistaController.renderizarListaTarefas(componentePrincipal);
});

$("#lista_responsavel").addEventListener("click", function() {
  fecharNavBar();
  responsavelController.renderizarListaresponsavel(componentePrincipal);
});
